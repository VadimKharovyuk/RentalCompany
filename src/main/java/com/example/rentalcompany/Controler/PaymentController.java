package com.example.rentalcompany.Controler;//package com.example.rentalcompany.Controler;
...
public class PaymentController {
    ...
    public String createPaymentForm(Model model) {
        ...
        model.addAttribute("paymentTypes", Payment.PaymentType.values()); // Все возможные типы платежей
        return "payment_form";
    }
